...
namespace Tactile.Constants
{
    public class Combat
    {
        ...
        public const float CRIT_MULT = 2f;
        public const int BASE_COMBAT_EXP = 10;
        public const int STEAL_EXP = 15;
        public const int DANCE_EXP = 15;
